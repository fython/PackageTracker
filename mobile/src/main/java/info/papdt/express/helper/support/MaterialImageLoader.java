...
public class MaterialImageLoader {
	...
	public static MaterialImageLoader animate(ImageView imageView) {
		return new MaterialImageLoader(imageView);
	}
	...
	public MaterialImageLoader setDuration(int duration) {
