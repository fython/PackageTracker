...
public abstract class SimpleRecyclerViewAdapter extends RecyclerView.Adapter<SimpleRecyclerViewAdapter.ClickableViewHolder> {
	...
	public SimpleRecyclerViewAdapter(RecyclerView recyclerView) {
